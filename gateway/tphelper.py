...
def getVars():
    ...
    vars = {
        ...
        'merch_callbackurl' : 'http://localhost:63342/WebApplication/gateway/callback/',#
        ...
        'merch_serverresulturl' : 'http://localhost:63342/WebApplication/callback-server/', #'http://takepayments-python-django.herokuapp.com/gateway/callback-server/',
